...
const weeklyChallenges = [
  {
    ...
    task: "Try a new food, show, song, or activity this week.",
    followUp: "Tell the family what you thought about it.",
  },
  {
    title: "Kindness Mission",
    task: "Do one kind thing for someone this week.",
    followUp: "Share what happened in the chat.",
  },
  {
    title: "Memory Week",
    task: "Share one favorite family memory.",
    followUp: "Tell everyone why you picked it.",
  },
];
    ...
    <main className="min-h-screen bg-black flex justify-center overflow-x-hidden">
      <div className="w-full max-w-[1024px] text-white p-4">
        ...
        <div className="text-center mb-6">
          <h1 className="text-7xl font-black italic">MEDINA</h1>
          <h2 className="text-6xl font-black italic text-red-500">
            CONNECT ❤️
          </h2>
        </div>
            ...
            <Panel title="📣 FAMILY CHISME">
              ...
              <form onSubmit={createChismePost} className="space-y-3 mb-4">
                <textarea
                  ...
                  className="w-full min-h-[100px] bg-black border-2 border-white/20 rounded-xl p-3"
                />
            ...
            <Panel title="💬 FAMILY CHAT">
              ...
              >
                <input
                  ...
                  className="bg-black border-2 border-white/20 rounded-lg px-3 py-3"
                />

                <button className="bg-red-600 rounded-lg font-black">
                  SEND
                </button>
              </form>
