  ...
  if (!user) {
    return (
      <main className="min-h-screen bg-black flex items-center justify-center p-6">
        ...
        <div className="bg-[#0c1020] border-4 border-purple-700 rounded-3xl p-8 w-full max-w-md text-white shadow-[8px_8px_0px_#000]">

          <h1 className="text-5xl font-black italic text-center mb-3">
            MEDINA
          </h1>
      ...
      >
        ...
        <div className="relative z-10 px-3 py-4">
          ...
          <div className="text-center mb-2">
            ...
            <h1
              className="text-6xl md:text-8xl font-black italic leading-none tracking-tight"
              style={{
            ...
            <h2
              className="text-5xl md:text-7xl font-black italic text-red-500 -mt-2"
              style={{
                textShadow: "6px 6px 0px #000",
              }}
            >
          ...
          <div className="grid grid-cols-[280px_1fr_280px] gap-3">
            ...
            <div className="space-y-4 pt-10">
              ...
              <Panel title="💬 DAILY TOPIC">
                ...
                <div className="bg-white text-black rounded-2xl border-4 border-black p-5 text-center text-2xl font-black">
                  {topic}
                </div>

                <button
                  onClick={randomTopic}
                  className="mt-4 w-full bg-purple-700 hover:bg-purple-800 text-white text-2xl font-black py-3 rounded-xl border-4 border-black"
                >
                  ⚡ NEW TOPIC
                </button>
              ...
              <Panel title="💬 FAMILY CHAT">
                ...
                >
                  ...
                  <input
                    ...
                    className="bg-black border-2 border-white/20 rounded-lg px-3 text-white"
                  />

                  <button className="bg-red-600 hover:bg-red-700 rounded-lg border-2 border-black font-black">
                    SEND
                  </button>
...
function ComicPhoto({ src, label, tall }) {
  return (
    <div className="relative bg-white border-4 border-black p-2 rotate-[-2deg]">

      <div
        className={`overflow-hidden ${
          tall ? "h-[420px]" : "h-[330px]"
        }`}
      >
        <img
          src={src}
      ...
      <div className="absolute bottom-4 left-3 right-3 bg-white text-black border-4 border-black font-black text-center px-3 py-2 text-2xl italic">
        {label} ❤️
      </div>
